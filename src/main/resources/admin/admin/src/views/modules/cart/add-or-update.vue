<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="飞机表名" prop="tablename">
          <el-input v-model="ruleForm.tablename"
              placeholder="飞机表名" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="飞机表名" prop="tablename">
              <el-input v-model="ruleForm.tablename"
                placeholder="飞机表名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="飞机id" prop="goodid">
          <el-input v-model="ruleForm.goodid"
              placeholder="飞机id" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="飞机id" prop="goodid">
              <el-input v-model="ruleForm.goodid"
                placeholder="飞机id" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="飞机名称" prop="goodname">
          <el-input v-model="ruleForm.goodname"
              placeholder="飞机名称" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="飞机名称" prop="goodname">
              <el-input v-model="ruleForm.goodname"
  ...
  data() {
	...
	discountprice : false,
            ...
            ruleForm: {
                  ...
                  goodid: [
                            { required: true, message: '飞机id不能为空', trigger: 'blur' },
                                    	                                                              ],
                  goodname: [
                                    	                                                              ],
                  picture: [
