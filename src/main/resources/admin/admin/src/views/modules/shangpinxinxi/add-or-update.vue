<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="飞机名称" prop="shangpinmingcheng">
                        <el-input v-model="ruleForm.shangpinmingcheng"
                                  placeholder="飞机名称" clearable :readonly="ro.shangpinmingcheng"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="飞机名称" prop="shangpinmingcheng">
                            <el-input v-model="ruleForm.shangpinmingcheng"
                                      placeholder="飞机名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'" label="飞机舱位" prop="shangpinfenlei">
                        <el-select v-model="ruleForm.shangpinfenlei" placeholder="请选择飞机舱位">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="飞机舱位" prop="shangpinfenlei">
                            <el-input v-model="ruleForm.shangpinfenlei"
                                      placeholder="飞机舱位" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="起点" prop="pinpai">
                        <el-input v-model="ruleForm.pinpai"
                                  placeholder="起点" clearable :readonly="ro.pinpai"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="起点" prop="pinpai">
                            <el-input v-model="ruleForm.pinpai"
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="终点" prop="guige">
                        <el-input v-model="ruleForm.guige"
                                  placeholder="终点" clearable :readonly="ro.guige"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="终点" prop="guige">
                            <el-input v-model="ruleForm.guige"
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="出发日期" prop="startdate">
                        <el-input v-model="ruleForm.startdate"
                                  placeholder="出发日期" clearable :readonly="ro.startdate"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="出发日期" prop="startdate">
                            <el-input v-model="ruleForm.startdate"
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'" label="飞机详情" prop="shangpinxiangqing">
                        <editor
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpinxiangqing" label="飞机详情" prop="shangpinxiangqing">
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    shangpinfenlei: [
                        {required: true, message: '飞机舱位不能为空', trigger: 'blur'},
                    ],
                    tupian: [],
                    pinpai: [],
                    guige: [],
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg, '../../../planestore/upload');
                    } else {
                        this.$message.error(data.msg);
                    }
                });
