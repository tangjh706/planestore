  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="订单编号" prop="dingdanbianhao">
              <el-input v-model="ruleForm.dingdanbianhao"
                placeholder="订单编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="飞机名称" prop="shangpinmingcheng">
          <el-select  @change="shangpinmingchengChange" v-model="ruleForm.shangpinmingcheng" placeholder="请选择飞机名称">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.shangpinmingcheng" label="飞机名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng"
                placeholder="飞机名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="飞机舱位" prop="shangpinfenlei">
          <el-input v-model="ruleForm.shangpinfenlei"
              placeholder="飞机舱位" clearable  :readonly="ro.shangpinfenlei"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="终点" prop="guige">
              <el-input v-model="ruleForm.guige"
                placeholder="终点" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="终点" prop="pingfen">
          <el-select v-model="ruleForm.pingfen" placeholder="请选择终点">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="终点" prop="pingfen">
